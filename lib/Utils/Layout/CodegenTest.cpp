  ...
  for (int c1 = 0; c1 <= 1; c1 += 1)
    for (int c2 = 0; c2 <= 7; c2 += 1)
      for (int c3 = 4 * c0; c3 <= 4 * c0 + 59; c3 += 1)
        if ((c3 % 8 >= 4 * c0 && 4 * c0 + 3 >= c3 % 8 && 2 * (c3 % 2) + c2 + 32 * floord(-(2 * (c3 % 2)) + 16 * c0 + 16 * c1 - c2 + 3 * c3 + 1, 32) >= 16 * c0 + 16 * c1 + 3 * c3) || (c3 % 8 >= 4 * c0 && 4 * c0 + 3 >= c3 % 8 && 16 * c0 + 16 * c1 + 3 * c3 >= 2 * (c3 % 2) + c2 + 32 * floord(-(2 * (c3 % 2)) + 16 * c0 + 16 * c1 - c2 + 3 * c3 + 1, 32) + 27 && 2 * (c3 % 2) + c2 + 32 * floord(-(2 * (c3 % 2)) + 16 * c0 + 16 * c1 - c2 + 3 * c3 + 1, 32) + 28 >= 16 * c0 + 16 * c1 + 3 * c3))
          S(c0, c1, 4 * c0 + 4 * c1 - c3 / 2 + floord(c2 - c3, 4) + 8 * ((-(2 * (c3 % 2)) - 16 * c0 - 16 * c1 - c2 + 3 * c3 + 39) / 32) - 8, c2 - c3 - 4 * floord(c2 - c3, 4), c2, c3);
)";
  ASSERT_THAT(result2.value(), Eq(expected2));
      ...
      for (int c3 = 0; c3 <= 1; c3 += 1)
        for (int c4 = 0; c4 <= 7; c4 += 1)
          for (int c5 = -((c3 - c4 + 7) % 4) + 4 * c0 + 3; c5 <= 4 * c0 + 59; c5 += 4)
            if (c5 % 8 >= 4 * c0 && 4 * c0 + 3 >= c5 % 8 && (-(2 * (c5 % 2)) - 16 * c0 - 16 * c1 + 4 * c2 + c3 - c4 + 3 * c5) % 32 == 0)
              S(c0, c1, c2, c3, c4, c5);
)";
  ASSERT_THAT(result3.value(), Eq(expected3));
}
