...
module attributes {scheme.ckks} {
  func.func @prepare(%param: !param, %encoder: !encoder) -> !lt {
    %diagonals = arith.constant dense<1.0> : tensor<2x4096xf64>
    %lt0 = lattigo.ckks.prepare_linear_transform %param, %encoder, %diagonals {diagonal_indices = array<i32: 0, 1>, levelQ = 5 : i64, logSlots = 12 : i64, logBabyStepGiantStepRatio = 0 : i64} : (!param, !encoder, tensor<2x4096xf64>) -> !lt
    return %lt0 : !lt
  }
