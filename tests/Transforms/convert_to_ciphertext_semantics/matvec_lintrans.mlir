...
// orion.linear_transform at SecretToCKKS) instead of unrolling to the BSGS
// mult/rotate/add expansion. Only the squat-packing post-shifts and the bias
// add are materialized.
