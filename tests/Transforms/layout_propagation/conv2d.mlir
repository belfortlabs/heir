...
// CHECK: @conv2d
// CHECK-SAME: %[[arg0:.*]]: !secret.secret<tensor<5x5xf32>> {tensor_ext.kernel_info = #tensor_ext.kernel_info<resultShape = [5, 5], gapFactor = 1>, tensor_ext.layout = [[rm_layout:.*]]}) ->
func.func @conv2d(%arg0: !secret.secret<tensor<5x5xf32>>) -> !secret.secret<tensor<3x3xf32>> {
  ...
  ^body(%input0: tensor<5x5xf32>):
    ...
    // CHECK-SAME: tensor_ext.kernel_info = #tensor_ext.kernel_info<resultShape = [3, 3], gapFactor = 1>
