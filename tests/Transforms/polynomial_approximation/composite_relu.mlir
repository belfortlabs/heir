// RUN: heir-opt --polynomial-approximation=use-composite-relu=true %s | FileCheck %s
...
func.func @test_composite_relu_prescale(%x: tensor<4xf32>) -> tensor<4xf32> {
...
func.func @test_composite_relu_unit_domain(%x: tensor<4xf32>) -> tensor<4xf32> {
