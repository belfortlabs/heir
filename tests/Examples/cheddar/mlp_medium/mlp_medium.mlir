...
module attributes {backend.cheddar, cheddar.P = array<i64: 536641537, 537133057>, cheddar.Q = array<i64: 536903681, 67043329, 67239937, 66813953, 67502081, 66551809, 67731457, 66420737, 68190209, 65929217, 68485121, 68681729, 68976641>, cheddar.logDefaultScale = 26 : i64, cheddar.logN = 14 : i64} {
  func.func @mlpmedium(%ctx: !context, %encoder: !encoder, %ui: !user_interface, %evk: !eval_key, %evk_map: !evk_map, %ct: tensor<!ciphertext>, %arg0: tensor<128x8192xf64> {orion.block_col = 0 : i64, orion.block_row = 0 : i64, orion.layer_name = "fc1", orion.layer_role = "weights", orion.level = 9 : i64}, %arg1: tensor<8192xf64> {orion.layer_name = "fc1", orion.layer_role = "bias", orion.level = 9 : i64}, %arg2: tensor<128x8192xf64> {orion.block_col = 0 : i64, orion.block_row = 0 : i64, orion.layer_name = "fc2", orion.layer_role = "weights", orion.level = 5 : i64}, %arg3: tensor<8192xf64> {orion.layer_name = "fc2", orion.layer_role = "bias", orion.level = 5 : i64}, %arg4: tensor<137x8192xf64> {orion.block_col = 0 : i64, orion.block_row = 0 : i64, orion.layer_name = "fc3", orion.layer_role = "weights", orion.level = 1 : i64}, %arg5: tensor<8192xf64> {orion.layer_name = "fc3", orion.layer_role = "bias", orion.level = 1 : i64}) -> tensor<!ciphertext> {
    ...
    %ct_2 = cheddar.hrot_add %ctx, %ui, %ct_0, %ct_0, %dps_2 {distance = 4096 : i32} : (!context, !user_interface, tensor<!ciphertext>, tensor<!ciphertext>, tensor<!ciphertext>) -> tensor<!ciphertext>
    %dps_3 = bufferization.alloc_tensor() : tensor<!ciphertext>
    %ct_3 = cheddar.hrot_add %ctx, %ui, %ct_2, %ct_2, %dps_3 {distance = 2048 : i32} : (!context, !user_interface, tensor<!ciphertext>, tensor<!ciphertext>, tensor<!ciphertext>) -> tensor<!ciphertext>
    %dps_4 = bufferization.alloc_tensor() : tensor<!ciphertext>
    %ct_4 = cheddar.hrot_add %ctx, %ui, %ct_3, %ct_3, %dps_4 {distance = 1024 : i32} : (!context, !user_interface, tensor<!ciphertext>, tensor<!ciphertext>, tensor<!ciphertext>) -> tensor<!ciphertext>
    %dps_5 = bufferization.alloc_tensor() : tensor<!ciphertext>
    %ct_5 = cheddar.hrot_add %ctx, %ui, %ct_4, %ct_4, %dps_5 {distance = 512 : i32} : (!context, !user_interface, tensor<!ciphertext>, tensor<!ciphertext>, tensor<!ciphertext>) -> tensor<!ciphertext>
    %dps_6 = bufferization.alloc_tensor() : tensor<!ciphertext>
    %ct_6 = cheddar.hrot_add %ctx, %ui, %ct_5, %ct_5, %dps_6 {distance = 256 : i32} : (!context, !user_interface, tensor<!ciphertext>, tensor<!ciphertext>, tensor<!ciphertext>) -> tensor<!ciphertext>
    %dps_7 = bufferization.alloc_tensor() : tensor<!ciphertext>
    %ct_7 = cheddar.hrot_add %ctx, %ui, %ct_6, %ct_6, %dps_7 {distance = 128 : i32} : (!context, !user_interface, tensor<!ciphertext>, tensor<!ciphertext>, tensor<!ciphertext>) -> tensor<!ciphertext>
    ...
    %ct_12 = cheddar.hrot_add %ctx, %ui, %ct_10, %ct_10, %dps_12 {distance = 4096 : i32} : (!context, !user_interface, tensor<!ciphertext>, tensor<!ciphertext>, tensor<!ciphertext>) -> tensor<!ciphertext>
    %dps_13 = bufferization.alloc_tensor() : tensor<!ciphertext>
    %ct_13 = cheddar.hrot_add %ctx, %ui, %ct_12, %ct_12, %dps_13 {distance = 2048 : i32} : (!context, !user_interface, tensor<!ciphertext>, tensor<!ciphertext>, tensor<!ciphertext>) -> tensor<!ciphertext>
    %dps_14 = bufferization.alloc_tensor() : tensor<!ciphertext>
    %ct_14 = cheddar.hrot_add %ctx, %ui, %ct_13, %ct_13, %dps_14 {distance = 1024 : i32} : (!context, !user_interface, tensor<!ciphertext>, tensor<!ciphertext>, tensor<!ciphertext>) -> tensor<!ciphertext>
    %dps_15 = bufferization.alloc_tensor() : tensor<!ciphertext>
    %ct_15 = cheddar.hrot_add %ctx, %ui, %ct_14, %ct_14, %dps_15 {distance = 512 : i32} : (!context, !user_interface, tensor<!ciphertext>, tensor<!ciphertext>, tensor<!ciphertext>) -> tensor<!ciphertext>
    %dps_16 = bufferization.alloc_tensor() : tensor<!ciphertext>
    %ct_16 = cheddar.hrot_add %ctx, %ui, %ct_15, %ct_15, %dps_16 {distance = 256 : i32} : (!context, !user_interface, tensor<!ciphertext>, tensor<!ciphertext>, tensor<!ciphertext>) -> tensor<!ciphertext>
    %dps_17 = bufferization.alloc_tensor() : tensor<!ciphertext>
    %ct_17 = cheddar.hrot_add %ctx, %ui, %ct_16, %ct_16, %dps_17 {distance = 128 : i32} : (!context, !user_interface, tensor<!ciphertext>, tensor<!ciphertext>, tensor<!ciphertext>) -> tensor<!ciphertext>
