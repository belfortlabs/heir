...
func.func @prepare() attributes {server.preprocessing_func = {func_name = "entry"}} {
  call @shared_layout() : () -> ()
  return
}
...
func.func @entry__server_setup(%out: !server_owner {bufferize.result})
    attributes {server.setup_func = {func_name = "entry"}} { return }
...
func.func @entry(%input: !ct_const, %flag: i1,
    ...
    attributes {heir.entry_func = {func_name = "entry"},
      ...
      heir.entry_input_types = [tensor<4xf32>, i1],
      heir.entry_result_types = [tensor<4xf32>, tensor<4xf32>]} { return }
func.func @encrypt(%ui: !ui, %input: !float, %out: !ct {bufferize.result})
    attributes {client.enc_func = {func_name = "entry", index = 0 : i64}} {
  call @shared_layout() : () -> ()
  return
}
func.func @encrypt_zero(%ui: !ui, %out: !ct {bufferize.result})
    attributes {client.enc_zero_func = {func_name = "entry", index = 0 : i64}} { return }
...
func.func @decrypt1(%ui: !ui, %input: !ct_const, %out: !float {bufferize.result})
    attributes {client.dec_func = {func_name = "entry", index = 1 : i64}} { return }
