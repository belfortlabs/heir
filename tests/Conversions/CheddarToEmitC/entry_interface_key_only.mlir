...
// RUN: heir-opt --cheddar-emitc-entry-interface %s | FileCheck %s --check-prefix=CHEDDAR
...
// CYCLOPS: verbatim "using PublicKey = const ::cyclops::EvkMap<word>*;"
// CYCLOPS: func @KeyGen
// The map lives inside the UserInterface the KeyPair owns.
// CYCLOPS: member_call_opaque {{.*}} "GetEvkMap"
// CYCLOPS: call_opaque "std::addressof"
// CYCLOPS: func @Evaluate
// CYCLOPS: call_opaque "heir::deref"
// CYCLOPS: call_opaque "heir::multiplicationKey"

// CHEDDAR: verbatim "using PublicKey = ::cheddar::UserInterface<word>*;"
// CHEDDAR-NOT: heir::multiplicationKey
// CHEDDAR-NOT: heir::deref
