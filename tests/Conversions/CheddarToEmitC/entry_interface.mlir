...
func.func @entry(
    ...
    attributes {
      heir.interface = {func_name = "entry", input_types = [tensor<4xf32>, tensor<2xf32>], result_types = [tensor<2xf32>], roles = ["entry"]}
    } {
  return
}
...
func.func @entry__encrypt__arg0(
    ...
    %out: !ct {bufferize.result})
    attributes {
      heir.interface = {func_name = "entry", index = 0 : i64, roles = ["client.encrypt"]}
    } {
  return
}
...
func.func @entry__encrypt__arg1(
    ...
    %out: !ct {bufferize.result})
    attributes {
      heir.interface = {func_name = "entry", index = 1 : i64, roles = ["client.encrypt"]}
    } {
  return
}
...
func.func @entry__decrypt__result0(
    ...
    attributes {
      heir.interface = {func_name = "entry", index = 0 : i64, roles = ["client.decrypt"]}
    } {
  return
}
